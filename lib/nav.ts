...
export const navGroups: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { title: "供应商台账", href: "/supply/suppliers", icon: Users, roles: ["R01"], desc: "自营/制造商/租赁商/调运供应商；自有箱见库存总表" },
    ],
  },
  {
    module: "M02",
    ...
    items: [
      ...
      { title: "调运价目", href: "/config/dispatch-prices", icon: Tags, roles: ["R00", "R01", "R02"], desc: "维护/查看调运报价（提箱堆场 + 还箱城市 + 单价）" },
  ...
  },
  {
    ...
    items: [
      ...
      { title: "反馈工单", href: "/admin/feedback", icon: MessageSquarePlus, roles: ["R00"], desc: "用户提交的 Bug / 需求工单处理" },
