...
export const RESOURCES = {
  orders: { table: "use_box_orders", id: "id", json: ["containerNos", "pickupDocs"], bool: ["releaseDocReady", "stuffingListUploaded", "returnProofUploaded"], seed: "useBoxOrders", module: "M01 客户门户", label: "用箱订单" },
