...
export const bills: Bill[] = [
  {
    ...
    items: [
      ...
      { label: "币种", value: "CNY" },
      { label: "汇率（对人民币）", value: "本币（CNY = 1）" },
      { label: "折合人民币", value: "¥38,400.00" },
      { label: "合计", value: "¥38,400.00" },
    ],
  },
  {
    id: "b2",
  ...
  },
  {
    ...
    items: [
      ...
      { label: "币种", value: "CNY" },
      { label: "汇率（对人民币）", value: "本币（CNY = 1）" },
      { label: "折合人民币", value: "¥3,200.00" },
      { label: "合计", value: "¥3,200.00" },
    ],
  },
  {
    id: "b4",
...
/** 调运价目方案（BR-11：提箱堆场 + 可选还箱城市集合） */
export const dispatchPriceRules: DispatchPriceRule[] = [
  { id: "ham-1", pickupPlace: "汉堡HCS", returnCities: ["不来梅", "汉诺威"], scope: "不来梅 / 汉诺威", unitPrice: 620, overdue: "¥100/箱/天", suggestTerm: 21, zone: "近距", enabled: true },
  { id: "ham-2", pickupPlace: "汉堡HCS", returnCities: ["杜伊斯堡", "纽伦堡", "慕尼黑"], scope: "杜伊斯堡 / 纽伦堡 / 慕尼黑", unitPrice: 850, overdue: "¥120/箱/天", suggestTerm: 30, zone: "中距", enabled: true },
  { id: "ham-3", pickupPlace: "汉堡HCS", returnCities: ["华沙", "布达佩斯", "维也纳"], scope: "华沙 / 布达佩斯 / 维也纳", unitPrice: 1180, overdue: "¥150/箱/天", suggestTerm: 45, zone: "远距", enabled: true },
  { id: "mal-1", pickupPlace: "马拉ADAMPOL", returnCities: ["华沙", "罗兹"], scope: "华沙 / 罗兹", unitPrice: 480, overdue: "¥100/箱/天", suggestTerm: 18, zone: "近距", enabled: true },
  { id: "mal-2", pickupPlace: "马拉ADAMPOL", returnCities: ["柏林", "布拉格"], scope: "柏林 / 布拉格", unitPrice: 720, overdue: "¥120/箱/天", suggestTerm: 25, zone: "中距", enabled: true },
  { id: "mal-3", pickupPlace: "马拉ADAMPOL", returnCities: ["西安", "郑州"], scope: "西安 / 郑州", unitPrice: 2600, overdue: "¥120/箱/天", suggestTerm: 45, zone: "远距", enabled: true },
  { id: "dui-1", pickupPlace: "杜堡dit", returnCities: ["汉堡", "不来梅"], scope: "汉堡 / 不来梅", unitPrice: 560, overdue: "¥100/箱/天", suggestTerm: 20, zone: "近距", enabled: true },
  { id: "dui-2", pickupPlace: "杜堡dit", returnCities: ["纽伦堡", "慕尼黑", "维也纳"], scope: "纽伦堡 / 慕尼黑 / 维也纳", unitPrice: 920, overdue: "¥130/箱/天", suggestTerm: 32, zone: "中距", enabled: true },
  { id: "nue-1", pickupPlace: "纽伦堡CDN", returnCities: ["慕尼黑", "维也纳"], scope: "慕尼黑 / 维也纳", unitPrice: 500, overdue: "¥100/箱/天", suggestTerm: 18, zone: "近距", enabled: true },
  { id: "nue-2", pickupPlace: "纽伦堡CDN", returnCities: ["西安"], scope: "西安", unitPrice: 2400, overdue: "¥120/箱/天", suggestTerm: 45, zone: "远距", enabled: true },
  { id: "bud-1", pickupPlace: "布达佩斯MCC", returnCities: ["维也纳", "布拉迪斯拉发"], scope: "维也纳 / 布拉迪斯拉发", unitPrice: 700, overdue: "¥120/箱/天", suggestTerm: 30, zone: "中距", enabled: true },
  { id: "bud-2", pickupPlace: "布达佩斯MCC", returnCities: ["华沙", "罗兹"], scope: "华沙 / 罗兹", unitPrice: 980, overdue: "¥140/箱/天", suggestTerm: 38, zone: "远距", enabled: true },
]
