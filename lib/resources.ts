...
export const RESOURCES = {
  orders: { table: "use_box_orders", id: "id", json: ["containerNos", "pickupDocs", "returnDocs"], bool: ["releaseDocReady", "stuffingListUploaded", "returnProofUploaded"], seed: "useBoxOrders", module: "M01 客户门户", label: "用箱订单" },
  ...
  containers: { table: "container_masters", id: "containerNo", json: [], bool: ["deleted"], seed: "containerMasters", module: "M03 库存管理", label: "集装箱主档" },
  ...
  repair: { table: "repair_orders", id: "id", json: ["processLog", "quoteLines"], bool: [], seed: "repairOrders", module: "M06 维修管理", label: "修箱工单" },
  ...
  dispatchApprovalChain: {
    table: "dispatch_approval_chain",
    id: "id",
    json: [],
    bool: [],
    seed: "dispatchApprovalChain",
    module: "M02 调运管理",
    label: "调运审批链",
  },
  settings: {
